...
var displayMap = function displayMap(locations) {
  ...
  //     // interactive: false
  //   });
  mapboxgl.accessToken = 'pk.eyJ1IjoiYnJpZ2lob3J2YXRoODIiLCJhIjoiY2psMHh1ZXNjMTl6NjNscXAxZGUzZjJvcyJ9.OueRj6WnXxfEWGh5VXon-w';
  var map = new mapboxgl.Map({
    container: 'map',
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'success') location.assign('/'); // this solution also may works, but maybe there are some problems,
...
// data is an object containing all that we want to update
...
var stripe = Stripe('pk_test_51JZYHPC51616cy0TxIwPoQtGHbRxQMso2KB12bvC0XIi671n85ow462XqlDWfo85qleUqh3FwutrS5JKJ1lLjO5L00OblIjRyt'); // tourId comes from the Book buttons data attribute
